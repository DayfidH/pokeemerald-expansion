...
enum
{
    ...
    OBJ_EVENT_GFX_ATTENDANT_F_HNS,
    OBJ_EVENT_GFX_ATTENDANT_M_HNS,
    OBJ_EVENT_GFX_BALDING_MAN_HNS,
    OBJ_EVENT_GFX_BATTLE_GIRL_HNS,
    OBJ_EVENT_GFX_BATTLE_TOWER_TRAINER_DUDE_HNS,
    ...
    OBJ_EVENT_GFX_BURGLAR_HNS,
    OBJ_EVENT_GFX_CAMPER_HNS,
    OBJ_EVENT_GFX_CAPTAIN_HNS,
    OBJ_EVENT_GFX_CHANNELER_HNS,
    OBJ_EVENT_GFX_COOK_HNS,
    OBJ_EVENT_GFX_COOLTRAINER_F_HNS,
    OBJ_EVENT_GFX_COOLTRAINER_M_HNS,
    OBJ_EVENT_GFX_ENGINEER_HNS,
    OBJ_EVENT_GFX_FAT_MAN_HNS,
    OBJ_EVENT_GFX_FIREBREATHER_HNS,
    OBJ_EVENT_GFX_FISHERMAN_HNS,
    OBJ_EVENT_GFX_GAMEBOY_KID_HNS,
    OBJ_EVENT_GFX_GENTLEMAN_HNS,
    OBJ_EVENT_GFX_GIRL_1_HNS,
    OBJ_EVENT_GFX_GYM_GUY_HNS,
    OBJ_EVENT_GFX_HIKER_HNS,
    OBJ_EVENT_GFX_JUGGLER_HNS,
    OBJ_EVENT_GFX_LASS_HNS,
    OBJ_EVENT_GFX_LINK_RECEPTIONIST_HNS,
    OBJ_EVENT_GFX_LITTLE_BOY_HNS,
    OBJ_EVENT_GFX_LITTLE_GIRL_HNS,
    OBJ_EVENT_GFX_MAN_HNS,
    OBJ_EVENT_GFX_MART_EMPLOYEE_HNS,
    OBJ_EVENT_GFX_MOM_HNS,
    OBJ_EVENT_GFX_MYSTERY_EVENT_DELIVERYMAN_HNS,
    OBJ_EVENT_GFX_NURSE_HNS,
    OBJ_EVENT_GFX_OFFICER_HNS,
    OBJ_EVENT_GFX_OLD_MAN_HNS,
    OBJ_EVENT_GFX_OLD_MAN_2_HNS,
    OBJ_EVENT_GFX_OLD_WOMAN_HNS,
    OBJ_EVENT_GFX_PICNICKER_HNS,
    OBJ_EVENT_GFX_PSYCHIC_M_HNS,
    OBJ_EVENT_GFX_ROCKER_HNS,
    OBJ_EVENT_GFX_SAGE_HNS,
    OBJ_EVENT_GFX_SAGE_ELDER_HNS,
    OBJ_EVENT_GFX_SAILOR_HNS,
    OBJ_EVENT_GFX_SCIENTIST_F_HNS,
    OBJ_EVENT_GFX_SCIENTIST_M_HNS,
    OBJ_EVENT_GFX_SCOTT_HNS,
    OBJ_EVENT_GFX_STEVEN_HNS,
    OBJ_EVENT_GFX_SUPER_NERD_HNS,
    OBJ_EVENT_GFX_SWIMMER_F_HNS,
    OBJ_EVENT_GFX_SWIMMER_F_LAND_HNS,
    OBJ_EVENT_GFX_SWIMMER_M_HNS,
    OBJ_EVENT_GFX_TUBER_F_HNS,
    OBJ_EVENT_GFX_TUBER_M_HNS,
    OBJ_EVENT_GFX_TUBER_M_SWIMMING_HNS,
    OBJ_EVENT_GFX_TWIN_HNS,
    OBJ_EVENT_GFX_WOMAN_1_HNS,
    OBJ_EVENT_GFX_WOMAN_2_HNS,
    OBJ_EVENT_GFX_WOMAN_3_HNS,
    OBJ_EVENT_GFX_WORKER_F_HNS,
    OBJ_EVENT_GFX_WORKER_M_HNS,
    OBJ_EVENT_GFX_YOUNGSTER_HNS,
    OBJ_EVENT_GFX_BLAINE_HNS,
    OBJ_EVENT_GFX_BLUE_HNS,
    OBJ_EVENT_GFX_BROCK_HNS,
    OBJ_EVENT_GFX_BUGSY_HNS,
    OBJ_EVENT_GFX_CHUCK_HNS,
    OBJ_EVENT_GFX_CLAIR_HNS,
    OBJ_EVENT_GFX_ERIKA_HNS,
    OBJ_EVENT_GFX_FALKNER_HNS,
    OBJ_EVENT_GFX_JANINE_HNS,
    OBJ_EVENT_GFX_JASMINE_HNS,
    OBJ_EVENT_GFX_MISTY_HNS,
    OBJ_EVENT_GFX_MORTY_HNS,
    OBJ_EVENT_GFX_PRYCE_HNS,
    OBJ_EVENT_GFX_SABRINA_HNS,
    OBJ_EVENT_GFX_SURGE_HNS,
    OBJ_EVENT_GFX_WHITNEY_HNS,
    OBJ_EVENT_GFX_BRUNO_HNS,
    OBJ_EVENT_GFX_KAREN_HNS,
    OBJ_EVENT_GFX_KOGA_HNS,
    OBJ_EVENT_GFX_LANCE_HNS,
    OBJ_EVENT_GFX_WILL_HNS,
    OBJ_EVENT_GFX_ARCHER_HNS,
    OBJ_EVENT_GFX_ARIANA_HNS,
    OBJ_EVENT_GFX_GIOVANNI_HNS,
    OBJ_EVENT_GFX_PETREL_HNS,
    OBJ_EVENT_GFX_PROTON_HNS,
    OBJ_EVENT_GFX_ROCKET_F_HNS,
    OBJ_EVENT_GFX_ROCKET_M_HNS,
    OBJ_EVENT_GFX_ANABEL_HNS,
    OBJ_EVENT_GFX_BRANDON_HNS,
    OBJ_EVENT_GFX_GRETA_HNS,
    OBJ_EVENT_GFX_LUCY_HNS,
    OBJ_EVENT_GFX_NOLAND_HNS,
    OBJ_EVENT_GFX_SPENSER_HNS,
    OBJ_EVENT_GFX_TUCKER_HNS,
    OBJ_EVENT_GFX_BILL_HNS,
    OBJ_EVENT_GFX_ELM_HNS,
    OBJ_EVENT_GFX_EUSINE_HNS,
    OBJ_EVENT_GFX_KIMONO_HNS,
    OBJ_EVENT_GFX_KURT_HNS,
    OBJ_EVENT_GFX_KURT_LYING_DOWN_HNS,
    OBJ_EVENT_GFX_PROF_OAK_HNS,
    OBJ_EVENT_GFX_RED_NORMAL_HNS,
    OBJ_EVENT_GFX_SILVER_HNS,
    OBJ_EVENT_GFX_BIRTH_ISLAND_STONE_HNS,
    OBJ_EVENT_GFX_BREAKABLE_ROCK_HNS,
    OBJ_EVENT_GFX_CUTTABLE_TREE_HNS,
    OBJ_EVENT_GFX_FOSSIL_HNS,
    OBJ_EVENT_GFX_ITEM_BALL_HNS,
    OBJ_EVENT_GFX_LEGENDARY_SHADOW_HNS,
    OBJ_EVENT_GFX_NO_TAIL_SLOWPOKE_HNS,
    OBJ_EVENT_GFX_PUSHABLE_BOULDER_HNS,
    OBJ_EVENT_GFX_SHINY_GYARADOS_HNS,
    OBJ_EVENT_GFX_SLEEPING_SNORLAX_HNS,
    OBJ_EVENT_GFX_SS_AQUA_HNS,
    OBJ_EVENT_GFX_SWIMMING_LAPRAS_HNS,
    OBJ_EVENT_GFX_TOWER_BEAM_HNS,
    OBJ_EVENT_GFX_TRAIN_EAST_HNS,
    OBJ_EVENT_GFX_TRAIN_WEST_HNS,
    OBJ_EVENT_GFX_WHIRLPOOL_HNS,
    OBJ_EVENT_GFX_LIGHT_HNS,
    OBJ_EVENT_GFX_MART_LIGHT_HNS,
    OBJ_EVENT_GFX_POKE_CENTER_LIGHT_HNS,
    OBJ_EVENT_GFX_SMALL_LIGHT_HNS,
    OBJ_EVENT_GFX_NURSE_CHANSEY_HNS,
    OBJ_EVENT_GFX_GOLD_NORMAL_HNS,
    OBJ_EVENT_GFX_GOLD_MACH_BIKE_HNS,
    OBJ_EVENT_GFX_GOLD_ACRO_BIKE_HNS,
    OBJ_EVENT_GFX_GOLD_SURFING_HNS,
    OBJ_EVENT_GFX_GOLD_UNDERWATER_HNS,
    OBJ_EVENT_GFX_GOLD_FIELD_MOVE_HNS,
    OBJ_EVENT_GFX_GOLD_FISHING_HNS,
    OBJ_EVENT_GFX_GOLD_WATERING_HNS,
    OBJ_EVENT_GFX_GOLD_DECORATING_HNS,
    OBJ_EVENT_GFX_KRIS_NORMAL_HNS,
    OBJ_EVENT_GFX_KRIS_MACH_BIKE_HNS,
    OBJ_EVENT_GFX_KRIS_ACRO_BIKE_HNS,
    OBJ_EVENT_GFX_KRIS_SURFING_HNS,
    OBJ_EVENT_GFX_KRIS_UNDERWATER_HNS,
    OBJ_EVENT_GFX_KRIS_FIELD_MOVE_HNS,
    OBJ_EVENT_GFX_KRIS_FISHING_HNS,
    OBJ_EVENT_GFX_KRIS_WATERING_HNS,
    OBJ_EVENT_GFX_KRIS_DECORATING_HNS,
    OBJ_EVENT_GFX_SKIER_F_HNS,
    OBJ_EVENT_GFX_SKIER_M_HNS,
    OBJ_EVENT_GFX_ALOLA_OAK_HNS,
    NUM_OBJ_EVENT_GFX,
};
...
// Aliases for deduplicated FRLG sprites
#define OBJ_EVENT_GFX_WOMAN_1_FRLG OBJ_EVENT_GFX_WOMAN_1_HNS
#define OBJ_EVENT_GFX_BLACK_BELT_FRLG OBJ_EVENT_GFX_BLACK_BELT_HNS
#define OBJ_EVENT_GFX_SAILOR_FRLG OBJ_EVENT_GFX_SAILOR_HNS
#define OBJ_EVENT_GFX_OLD_WOMAN_FRLG OBJ_EVENT_GFX_OLD_WOMAN_HNS
#define OBJ_EVENT_GFX_GENTLEMAN_FRLG OBJ_EVENT_GFX_GENTLEMAN_HNS
#define OBJ_EVENT_GFX_WOMAN_3_FRLG OBJ_EVENT_GFX_WOMAN_3_HNS
#define OBJ_EVENT_GFX_POKE_MANIAC_FRLG OBJ_EVENT_GFX_SUPER_NERD_HNS
#define OBJ_EVENT_GFX_YOUNGSTER_FRLG OBJ_EVENT_GFX_YOUNGSTER_HNS
#define OBJ_EVENT_GFX_LASS_FRLG OBJ_EVENT_GFX_LASS_HNS
#define OBJ_EVENT_GFX_HIKER_FRLG OBJ_EVENT_GFX_HIKER_HNS
#define OBJ_EVENT_GFX_NURSE_FRLG OBJ_EVENT_GFX_NURSE_HNS
#define OBJ_EVENT_GFX_BUG_CATCHER_FRLG OBJ_EVENT_GFX_BUG_CATCHER_HNS
#define OBJ_EVENT_GFX_WOMAN_2_FRLG OBJ_EVENT_GFX_WOMAN_2_HNS
#define OBJ_EVENT_GFX_FAT_MAN_FRLG OBJ_EVENT_GFX_FAT_MAN_HNS
#define OBJ_EVENT_GFX_LITTLE_GIRL_FRLG OBJ_EVENT_GFX_LITTLE_GIRL_HNS
